...
- [ ] T010a **Worked example on the landing page** — one real check shown end to end: pasted text →
  ...
  **Done 2026-09-09.** `WorkedExample.tsx`, collapsed by default under the input and hidden once a
  run starts. Fixture is `frontend/src/data/workedExample.ts`, generated by core's
